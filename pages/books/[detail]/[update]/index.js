          ...
          <table class="table-fixed mx-auto w-10/12 text-left">
            <tbody>
              ...
              <tr>
                ...
                <th className="bg-green-100 w-3">:</th>
                <td className="bg-green-100">
                  <input type="text" required name="summary" id="summary" placeholder="summary . . ." onKeyDown={handleKeyPress} onChange={handleChange} value={formData.summary} className="italic text-sm bg-green-100 w-full outline-none" />
                </td>
              </tr>
              <tr>
                <th className="bg-slate-100">
              ...
              <tr>
                ...
                <th className="bg-green-100 w-3">:</th>
                <td className="bg-green-100">
                  <input type="number" required name="readPage" id="readPage" placeholder="25 . . ." onKeyDown={handleKeyPress} onChange={handleChange} value={formData.readPage} className="italic text-sm bg-green-100 w-full outline-none" />
                </td>
              </tr>
